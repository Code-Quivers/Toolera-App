...
CREATE TABLE "ThemeSettings" (
	"id" text PRIMARY KEY NOT NULL,
	"primary" text DEFAULT '#0F172A' NOT NULL,
	"accent" text DEFAULT '#0D9488' NOT NULL,
	"background" text DEFAULT '#FFFFFF' NOT NULL,
	"surface" text DEFAULT '#F8FAFC' NOT NULL,
	"text" text DEFAULT '#0F172A' NOT NULL,
	"muted" text DEFAULT '#64748B' NOT NULL,
	"border" text DEFAULT '#E2E8F0' NOT NULL,
	"headingFont" text DEFAULT 'Inter' NOT NULL,
	"bodyFont" text DEFAULT 'Inter' NOT NULL,
	"radius" text DEFAULT '1rem' NOT NULL,
	"shadow" text DEFAULT 'subtle' NOT NULL,
	"containerWidth" text DEFAULT '1280px' NOT NULL,
	"sectionSpacing" text DEFAULT '3rem' NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "User" (
...
CREATE INDEX "Expense_storeId_idx" ON "Expense" USING btree ("storeId");--> statement-breakpoint
...
CREATE INDEX "StockLog_storeId_idx" ON "StockLog" USING btree ("storeId");--> statement-breakpoint
